...
$posts = [
    ["Welcome my sheep", "Lebron", "Welcome to my house my LeChildren"],
    ['LeBron: The GOAT', 'KingJamesFan42', 'LeBron James is undoubtedly the greatest player to ever grace the basketball court. His accolades speak for themselves, and every time he steps on the floor, it’s pure magic. I truly believe we’re witnessing the best of all time right in front of our eyes. The way he continues to dominate at his age is unprecedented. Who agrees with me that LeBron is the GOAT?'],
    ['The Legacy of LeBron: More Than Just Basketball', 'LeBron4Life23', 'LeBron is more than just an athlete – he’s a cultural icon. The impact he has on society, especially with his charitable work, has cemented his legacy in ways that go beyond basketball. His foundation is helping to change lives, and he’s always striving to be a role model for the next generation. LeBron will forever be a symbol of greatness, both on and off the court.'],
    ['LeBron vs MJ: The Ultimate Debate', 'BronnyFan', 'I know we all have our opinions, but I think we can all agree that comparing LeBron to Michael Jordan is a debate that will never end. While MJ revolutionized the game and built his dynasty in the \'90s, LeBron’s ability to adapt and still perform at an elite level in today\'s NBA is unmatched. What do you all think? LeBron’s longevity and versatility make him the clear GOAT in my book.'],
    ...
    ['LeBron’s Greatest Rivalries', 'NBAHistorian', 'One thing that stands out about LeBron’s career is the intensity of his rivalries. From his fierce battles against the Warriors in the Finals to his rivalry with Paul George and the Pacers in the East, LeBron has faced some of the toughest competition ever. Those matchups defined an era of basketball. What rivalry do you think defined LeBron’s career the most? For me, it’s his back-and-forth with the Warriors in the 2010s.'],
    ['LeBron’s Impact on the Game’s Evolution', 'BasketballScholar', 'LeBron has changed the game of basketball in so many ways. His ability to play multiple positions, his basketball IQ, and his leadership skills have pushed the evolution of the modern NBA. He’s not just a scorer – he’s a complete player. The way he’s reshaped what a “superstar” looks like is a testament to his influence on the game. The future of the NBA will undoubtedly be shaped by LeBron’s legacy.'],
    ['LeBron is the Perfect Role Model', 'Guest', 'LeBron James has always been an inspiration for young athletes. Not only for his incredible work ethic and perseverance, but for the way he carries himself off the court. He’s humble, generous, and deeply passionate about giving back. He’s shown us that you can be a superstar and still be a good person, which is why he’s not just a sports icon – he’s a role model for all of us.']
];
...
foreach ($posts as $post) {
    ...
    $stmt = $db->prepare("INSERT INTO posts (post_title, post_content, author) VALUES (:post_title, :post_content, :author)");
